...
const tslib_1 = __nccwpck_require__(4834);
const axios_1 = __nccwpck_require__(7909);
...
const tslib_1 = __nccwpck_require__(4834);
const axios_1 = tslib_1.__importDefault(__nccwpck_require__(7909));
const Request_1 = __nccwpck_require__(4216);
class Webhook {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.Embed = exports.Webhook = void 0;
var Webhook_1 = __nccwpck_require__(7348);
Object.defineProperty(exports, "Webhook", ({ enumerable: true, get: function () { return Webhook_1.Webhook; } }));
var Embed_1 = __nccwpck_require__(2376);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const tslib_1 = __nccwpck_require__(4834);
tslib_1.__exportStar(__nccwpck_require__(7101), exports);
...
module.exports =
{
  parallel      : __nccwpck_require__(8403),
  serial        : __nccwpck_require__(8068),
  serialOrdered : __nccwpck_require__(5167)
};
...
var defer = __nccwpck_require__(5530);
...
var async = __nccwpck_require__(5146)
  , abort = __nccwpck_require__(5008)
  ;
...
var abort = __nccwpck_require__(5008)
  , async = __nccwpck_require__(5146)
  ;
...
var iterate    = __nccwpck_require__(7484)
  , initState  = __nccwpck_require__(1855)
  , terminator = __nccwpck_require__(5357)
  ;
...
var serialOrdered = __nccwpck_require__(5167);
...
var bind = __nccwpck_require__(7650);

var $apply = __nccwpck_require__(2255);
var $call = __nccwpck_require__(3075);
var $reflectApply = __nccwpck_require__(2460);
...
var bind = __nccwpck_require__(7650);
var $TypeError = __nccwpck_require__(7052);

var $call = __nccwpck_require__(3075);
var $actualApply = __nccwpck_require__(1909);
...
var DelayedStream = __nccwpck_require__(9624);
...
module.exports = __nccwpck_require__(5427)(exports);
...
function setup(env) {
	...
	createDebug.humanize = __nccwpck_require__(9778);
...
if (typeof process === 'undefined' || process.type === 'renderer' || process.browser === true || process.__nwjs) {
	...
	module.exports = __nccwpck_require__(8286);
}
...
try {
	...
	const supportsColor = __nccwpck_require__(321);
...
var callBind = __nccwpck_require__(5695);
var gOPD = __nccwpck_require__(6424);
...
var GetIntrinsic = __nccwpck_require__(4784);

var $defineProperty = GetIntrinsic('%Object.defineProperty%', true);

var hasToStringTag = __nccwpck_require__(2249)();
var hasOwn = __nccwpck_require__(8714);
var $TypeError = __nccwpck_require__(7052);
...
module.exports = function () {
  if (!debug) {
    try {
      ...
      debug = __nccwpck_require__(4640)("follow-redirects");
    }
    catch (error) { /* */ }
...
var debug = __nccwpck_require__(4780);
...
var CombinedStream = __nccwpck_require__(3720);
var util = __nccwpck_require__(9023);
...
var mime = __nccwpck_require__(9322);
var asynckit = __nccwpck_require__(7586);
var setToStringTag = __nccwpck_require__(6018);
var hasOwn = __nccwpck_require__(8714);
var populate = __nccwpck_require__(9341);
...
var implementation = __nccwpck_require__(8074);
...
var $Object = __nccwpck_require__(9677);

var $Error = __nccwpck_require__(6190);
var $EvalError = __nccwpck_require__(3446);
var $RangeError = __nccwpck_require__(1219);
var $ReferenceError = __nccwpck_require__(2671);
var $SyntaxError = __nccwpck_require__(3155);
var $TypeError = __nccwpck_require__(7052);
var $URIError = __nccwpck_require__(2492);

var abs = __nccwpck_require__(3135);
var floor = __nccwpck_require__(465);
var max = __nccwpck_require__(7057);
var min = __nccwpck_require__(3843);
var pow = __nccwpck_require__(297);
var round = __nccwpck_require__(1015);
var sign = __nccwpck_require__(1778);

var $gOPD = __nccwpck_require__(6424);
var $defineProperty = __nccwpck_require__(5868);
...
var hasSymbols = __nccwpck_require__(6966)();

var getProto = __nccwpck_require__(9953);
var $ObjectGPO = __nccwpck_require__(6961);
var $ReflectGPO = __nccwpck_require__(131);
...
var getAsyncFunction = __nccwpck_require__(609);
var getGeneratorFunction = __nccwpck_require__(6034);
var getAsyncGeneratorFunction = __nccwpck_require__(8705);
...
var reflectGetProto = __nccwpck_require__(131);
var originalGetProto = __nccwpck_require__(6961);

var getDunderProto = __nccwpck_require__(1207);
...
/** @type {import('.')} */
var $gOPD = __nccwpck_require__(1964);
...
var hasSymbolSham = __nccwpck_require__(6396);
...
var hasSymbols = __nccwpck_require__(6396);
...
const debug_1 = __importDefault(__nccwpck_require__(4640));
const agent_base_1 = __nccwpck_require__(2905);
const parse_proxy_response_1 = __importDefault(__nccwpck_require__(4933));
...
const agent_1 = __importDefault(__nccwpck_require__(2446));
...
const debug_1 = __importDefault(__nccwpck_require__(4640));
const promisify_1 = __importDefault(__nccwpck_require__(6401));
...
var $isNaN = __nccwpck_require__(7670);
...
module.exports = __nccwpck_require__(8761)
...
var db = __nccwpck_require__(8211)
...
const inputs_1 = __nccwpck_require__(4427);
const release_1 = __nccwpck_require__(3613);
const repo_1 = __nccwpck_require__(3078);
const store_1 = __nccwpck_require__(3457);
const files_1 = __nccwpck_require__(8695);
const auth_1 = __nccwpck_require__(9208);
const hook_1 = __nccwpck_require__(7185);
const output_1 = __nccwpck_require__(6067);
async function run() {
    try {
        const baseRepoData = (0, repo_1.getRepoData)();
        const { octokit, repoData } = await (0, auth_1.authGithubApp)({ baseRepoData });
        const inputs = await (0, inputs_1.getInputs)({ api: octokit, repoData });
        const releaseResponse = await (0, release_1.writeRelease)({ inputs, api: octokit, repoData });
        await (0, store_1.storeReleaseData)({ inputs, api: octokit, repoData });
        await (0, files_1.uploadFiles)({ api: octokit, inputs, release: releaseResponse, repoData });
        await (0, hook_1.sendWebhook)({ inputs, api: octokit, repoData, releaseResponse });
        await (0, output_1.setOutputs)({ release: releaseResponse, inputs });
...
const auth_app_1 = __nccwpck_require__(1946);
const core_1 = __nccwpck_require__(8196);
const plugin_rest_endpoint_methods_1 = __nccwpck_require__(6840);
const request_1 = __nccwpck_require__(7392);
async function authGithubApp(inp) {
...
const parse = __importStar(__nccwpck_require__(3017));
...
async function uploadProvidedFiles(inp) {
    const { api, inputs, release, repoData } = inp;
...
async function uploadReleaseData(inp) {
...
async function saveOfflineMetadata(inp) {
...
const discord_webhook_1 = __nccwpck_require__(5230);
async function sendWebhook(inp) {
...
const path_1 = __importDefault(__nccwpck_require__(6928));
const markdown_escape_1 = __importDefault(__nccwpck_require__(3253));
const glob_1 = __nccwpck_require__(9191);
async function getInputs(inp) {
...
function getFiles() {
    ...
    for (const file of parse.parseMultiInput(files)) {
        ...
        const files = (0, glob_1.globSync)(filePath);
        if (files.length > 1) {
...
async function getDiscussionCategory(inp) {
...
async function writeRelease(inp) {
...
const core_1 = __importDefault(__nccwpck_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module '@actions/core'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())));
...
var FormData$1 = __nccwpck_require__(8104);
var crypto = __nccwpck_require__(6982);
var url = __nccwpck_require__(7016);
var HttpsProxyAgent = __nccwpck_require__(7511);
var http = __nccwpck_require__(8611);
var https = __nccwpck_require__(5692);
var http2 = __nccwpck_require__(5675);
var util = __nccwpck_require__(9023);
var path = __nccwpck_require__(6928);
var followRedirects = __nccwpck_require__(4339);
...
async function exchangeWebFlowCode(options) {
  const request = options.request || dist_bundle.request;
...
function createOAuthDeviceAuth(options) {
  const requestWithDefaults = options.request || dist_bundle.request.defaults({
    headers: {
...
function createOAuthUserAuth({
  ...
  clientSecret,
  clientType = "oauth-app",
  request = dist_bundle.request.defaults({
    headers: {
...
function createAppAuth(options) {
  ...
  const request = options.request || dist_bundle.request.defaults({
    headers: {
...
// pkg/dist-src/index.js
var graphql2 = withDefaults(dist_bundle.request, {
  headers: {
    "user-agent": `octokit-graphql.js/${VERSION} ${(0,universal_user_agent/* getUserAgent */.$)()}`
  },
  method: "POST",
  url: "/graphql"
});
...
const userAgentTrail = `octokit-core.js/${version_VERSION} ${(0,universal_user_agent/* getUserAgent */.$)()}`;
class Octokit {
  ...
  constructor(options = {}) {
    ...
    const requestDefaults = {
      baseUrl: dist_bundle.request.endpoint.DEFAULTS.baseUrl,
      headers: {},
    ...
    this.request = dist_bundle.request.defaults(requestDefaults);
...
var dist = __nccwpck_require__(3572);
