...
export function getRepoData(requestedBranch: string | undefined): BaseRepo {
    ...
    const branch = requestedBranch || parse.removePrefix(process.env.GITHUB_REF, 'refs/heads/');
